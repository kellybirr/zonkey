...
namespace Zonkey.ObjectModel
{
    ...
    public interface IDataMapField
    {
        ...
        /// <summary>
        /// Gets or sets a value that tell the DataClassAdapter to include 
        /// this field in the WHERE clause of a Update and SelectBack operations.
        /// This is extremely useful for partitioned databases to improve performance.
    ...
    /// <summary>
    /// Provides an interface that gets the key of a data object
    /// </summary>
