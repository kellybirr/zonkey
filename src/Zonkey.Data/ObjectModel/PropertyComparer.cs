...
namespace Zonkey.ObjectModel
{
    ...
    {
        private const BindingFlags _publicIgnoreCase = BindingFlags.Instance | BindingFlags.Public | BindingFlags.IgnoreCase;
        ...
        public PropertyComparer(PropertyDescriptor property, ListSortDirection direction)
        {
            ...
            _propertyInfo = typeof(T).GetTypeInfo().GetProperty(property.Name, _publicIgnoreCase);
            _stringComparison = StringComparison.CurrentCulture;
        }
        ...
        /// <param name="property">The <see cref="System.ComponentModel.PropertyDescriptor"/> instance of the property on a class.</param>
        /// <param name="direction">The direction.</param>
        /// <param name="stringComparison">The <see cref="StringComparison"/> to use when comparing strings.</param>
        public PropertyComparer(PropertyDescriptor property, ListSortDirection direction, StringComparison stringComparison)
        {
            _direction = direction;
            _propertyInfo = typeof(T).GetTypeInfo().GetProperty(property.Name, _publicIgnoreCase);
        ...
        {
            _direction = direction;
            _propertyInfo = typeof(T).GetTypeInfo().GetProperty(propertyName, _publicIgnoreCase);
            _stringComparison = StringComparison.CurrentCulture;
        }
        ...
        /// <param name="direction">The <see cref="ListSortDirection"/> to sort.</param>
        /// <param name="stringComparison">The <see cref="StringComparison"/> to use when comparing strings.</param>
        public PropertyComparer(string propertyName, ListSortDirection direction, StringComparison stringComparison)
        {
            _direction = direction;
            _propertyInfo = typeof(T).GetTypeInfo().GetProperty(propertyName, _publicIgnoreCase);
            _stringComparison = stringComparison;
        ...
        /// </param>
        /// <param name="stringComparison">The <see cref="StringComparison"/> to use when comparing strings.</param>
        public PropertyComparer(string propertyName, bool descending, StringComparison stringComparison)
        {
            _direction = (descending) ? ListSortDirection.Descending : ListSortDirection.Ascending;
            _propertyInfo = typeof(T).GetTypeInfo().GetProperty(propertyName, _publicIgnoreCase);
            _stringComparison = stringComparison;
        ...
        public int Compare(T x, T y)
        {
            ...
            int resultS = string.Compare(xValue.ToString(), yValue.ToString(), _stringComparison);
