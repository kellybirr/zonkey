...
{
	[DataItem("TransactionHistoryArchive", SchemaName = "Production")]
	public class Production_TransactionHistoryArchive : DataClass
	{
		#region Data Columns (Properties)

		[DataField("TransactionID", DbType.Int32, false, IsKeyField = true)]
		...
		public Production_TransactionHistoryArchive(bool addingNew) : base(addingNew)
		{
			if (addingNew)
			{
			}
		...
		public Production_TransactionHistoryArchive() : this(false)
		{ }
