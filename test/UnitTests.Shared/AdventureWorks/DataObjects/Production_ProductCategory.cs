...
{
	[DataItem("ProductCategory", SchemaName = "Production")]
	public class Production_ProductCategory : DataClass
	{
		#region Data Columns (Properties)

		[DataField("ProductCategoryID", DbType.Int32, false, IsKeyField = true, IsAutoIncrement = true)]
		...
		public Production_ProductCategory(bool addingNew) : base(addingNew)
		{
			if (addingNew)
			{
			}
		...
		public Production_ProductCategory() : this(false)
		{ }
