...
{
	[DataItem("vIndividualCustomer", SchemaName = "Sales")]
	public class Sales_vIndividualCustomer : DataClass
	{
		...
		[DataField("AddressType", DbType.String, false, Length = 50)]
		public string AddressType
		{
			get { return _addressType; }
			set { SetFieldValue(ref _addressType, value); }
		}
		...
		public Sales_vIndividualCustomer(bool addingNew) : base(addingNew)
		{
			if (addingNew)
			{
			}
		...
		public Sales_vIndividualCustomer() : this(false)
		{ }
